module.exports = {
	forbidden: [
		...
		{ name: "no-pr-to-prompt-queue", severity: "error", from: { path: "^src/pr/" }, to: { path: "^src/prompt-queue/", dependencyTypesNot: ["type-only"] } },
		...
		{ name: "no-todoist-to-prompt-queue", severity: "error", from: { path: "^src/todoist/" }, to: { path: "^src/prompt-queue/", dependencyTypesNot: ["type-only"] } },
		...
		{ name: "no-herdr-to-prompt-queue", severity: "error", from: { path: "^src/herdr/" }, to: { path: "^src/prompt-queue/", dependencyTypesNot: ["type-only"] } },
		...
		{ name: "no-worktree-to-prompt-queue", severity: "error", from: { path: "^src/worktree/" }, to: { path: "^src/prompt-queue/", dependencyTypesNot: ["type-only"] } },
		...
		{ name: "no-footer-to-prompt-queue", severity: "error", from: { path: "^src/footer/" }, to: { path: "^src/prompt-queue/", dependencyTypesNot: ["type-only"] } },
