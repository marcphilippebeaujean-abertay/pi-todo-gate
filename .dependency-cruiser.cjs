module.exports = {
	forbidden: [
		...
		{ name: "no-shared-to-scoped-implementation", severity: "error", from: { path: "^src/shared/" }, to: { path: "^src/(pr|todoist|herdr|worktree|prompt-queue|exit-protocol|footer)/(?!module-state\\.ts$)[^/]+\\.ts$" } },
		{ name: "no-shared-to-internal-state", severity: "error", from: { path: "^src/shared/" }, to: { path: "^src/(pr|todoist|herdr|worktree|prompt-queue|exit-protocol|footer)/internal-state\\.ts$" } },
		{ name: "no-root-to-internal-state", severity: "error", from: { path: "^src/", pathNot: "^src/(shared|pr|todoist|herdr|worktree|prompt-queue|exit-protocol|footer)/" }, to: { path: "^src/(pr|todoist|herdr|worktree|prompt-queue|exit-protocol|footer)/internal-state\\.ts$" } },
