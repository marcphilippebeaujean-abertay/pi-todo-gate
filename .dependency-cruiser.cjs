module.exports = {
	forbidden: [
		...
		{ name: "no-root-to-internal-state", severity: "error", from: { path: "^src/(?!shared/|pr/|todoist/|herdr/|worktree/|exit-protocol/|footer/)[^/]+\\.ts$" }, to: { path: "^src/(pr|todoist|herdr|worktree|exit-protocol|footer)/internal-state\\.ts$" } },
