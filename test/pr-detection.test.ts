...
describe("githubPrUrl", () => {
  it("accepts a valid GitHub pull request URL", () => {
    expect(githubPrUrl("https://github.com/owner/repo/pull/42")).toBe("https://github.com/owner/repo/pull/42");
  });

  it("removes query, hash, and trailing punctuation", () => {
    expect(githubPrUrl("See (https://github.com/owner/repo/pull/42?tab=files#x)."))
