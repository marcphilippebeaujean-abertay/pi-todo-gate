...
- Task 8: complete — follow-up blockers fixed: typed lifecycle dispatch, adapter/runtime removal, separate PR/Todoist projections, root-owned epoch token; `env -u PI_SUBAGENT_CHILD npm test` passed 311 tests / 8 skipped, architecture/lint/typecheck/diff checks passed; report at `task-8-report.md`; final commit pending.
