...
export const EXIT_EMPTY = "";
export const EXIT_TAB_KEY = "tab";
export const EXIT_SUBMIT_LABEL = "Submit";
export const EXIT_CANCEL_LABEL = "Cancel";
export const EXIT_SELECTED = "x";
export const EXIT_UNSELECTED = " ";
export const EXIT_FOCUSED = ">";
export const EXIT_UNFOCUSED = " ";
...
export const REMOVE_WORKTREE_LABEL_SUFFIX = '"';
