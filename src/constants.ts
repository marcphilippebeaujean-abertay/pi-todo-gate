export const EXTENSION_CONSTANTS = {
	...
	worktree: {
		...
		cleanupScheduled: "Worktree cleanup scheduled for session exit",
		...
		removedBranchFailed: "Worktree removed, but local branch deletion failed: ",
		statusUnavailable: "Worktree cleanup failed: Git status unavailable",
		confirmTitle: "Remove worktree with uncommitted changes?",
		confirmPrefix: "Worktree ",
		confirmSuffix: " has uncommitted changes. Force removal will delete them.",
	},
	exit: {
		title: "Exit protocol",
		empty: "",
		...
		focused: ">",
		unfocused: " ",
		exitActionFailed: "Exit action failed: ",
	},
	message: {
