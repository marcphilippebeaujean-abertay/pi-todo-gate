...
export class Footer implements FooterEntry {
	...
	update(event: FooterEntryState): void {
...
export class FooterDisplay {
	...
	update(state: FooterState, event: FooterEntryState): void {
		this.state = state;
	...
	private syncEvent(context: SessionRecord, event: FooterEntryState): void {
